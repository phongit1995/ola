...
var (
	...
	errorsNotFound = map[string]bool{
		...
		"conversation not found in inbox":      true,
		"conversation not found in user inbox": true,
	...
	errorsForbidden = map[string]bool{
		...
		"you are not a member of this clan":             true,
		"you are banned from this clan":                 true,
		"clan is closed for joining":                    true,
		"clan requires verification to view":            true,
		"you are not allowed to post in this clan":      true,
		"only the clan owner or deputy can post public": true,
		"owner cannot leave the clan":                   true,
		"cannot ban clan staff":                         true,
		"only the clan owner can do this":               true,
