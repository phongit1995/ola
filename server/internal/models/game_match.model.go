...
type GameMatch struct {
	...
	PlayerCount int        `gorm:"not null;default:2" json:"playerCount"`
...
type GameMatchPlayer struct {
	...
	GameMatchID uuid.UUID `gorm:"type:uuid;not null" json:"gameMatchId"`
...
func (GameMatchPlayer) TableName() string {
	return "game_match_players"
}
