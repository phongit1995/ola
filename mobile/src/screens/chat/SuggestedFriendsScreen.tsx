      ...
      <View className="flex-1 bg-white">
        ...
        {list.length > 0 && (
          <View className="p-2" style={{ borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.12)' }}>
            <Pressable onPress={addAll} className="items-center rounded bg-ola-primary py-2">
              <Text className="text-sm font-medium text-white">{t('chat.makeFriendAll')}</Text>
            </Pressable>
          </View>
        )}
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                >
                  <Text className="text-xl font-medium text-white">{item.name.charAt(0).toUpperCase()}</Text>
                </View>
                <View className="min-w-0 flex-1">
                  ...
                  >
                    <Text className="text-sm font-medium text-white">{t('chat.menuMakeFriend')}</Text>
                  </Pressable>
                </View>
                <Pressable
                ...
                >
                  <Text className="text-xl" style={{ color: 'rgba(0,0,0,0.38)' }}>×</Text>
                </Pressable>
              </View>
            )}
          />
