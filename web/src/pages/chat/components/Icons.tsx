...
export function CheckIcon({ className = 'h-3.5 w-3.5 text-white' }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden="true">
...
export function CloseIcon({ className = 'h-5 w-5', strokeWidth = 2 }: StrokeIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
export function PeopleIcon({ className = 'h-6 w-6 text-black/54' }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden="true">
