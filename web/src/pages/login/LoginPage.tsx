...
import { useSavedAccountsStore } from './savedAccountsStore';
...
export function LoginPage() {
  ...
  function pickAccount(account: SavedAccount) {
    ...
    setValue('password', decodeSecret(account.secret), {
      shouldValidate: true,
    });
    clearError();
  }
  ...
  async function onSubmit(data: LoginForm) {
    ...
    try {
      ...
      const message =
        err instanceof ApiError ? err.message : t('auth.errGeneric');
      setError(message);
      toast.error(message);
    } finally {
      setLoading(false);
        ...
        >
          <ClearableInput
            field={register('username', {
              ...
              minLength: {
                value: USERNAME_MIN,
                message: t('login.errUsernameLength'),
              },
              maxLength: {
                value: USERNAME_MAX,
                message: t('login.errUsernameLength'),
          ...
          <ClearableInput
            field={register('password', {
              ...
              minLength: {
                value: PASSWORD_MIN,
                message: t('login.errPasswordLength'),
              },
              maxLength: {
                value: PASSWORD_MAX,
                message: t('login.errPasswordLength'),
