...
import { Avatar, FullScreenOverlay, ScreenHeader, Spinner, UserName } from '@components';
  ...
  return (
    <FullScreenOverlay>
      ...
      {loading ? (
        ...
        <p className="px-6 py-10 text-center text-sm text-black/45">{t('clan.emptyBans')}</p>
      ) : (
