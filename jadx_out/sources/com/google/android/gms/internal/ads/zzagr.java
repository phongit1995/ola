...
public final class zzagr extends com.google.android.gms.ads.internal.zzd implements zzahu {
    ...
    private static zzaji zzc(zzaji zzajiVar) {
        ...
        try {
            JSONObject jSONObjectZzb = zzafs.zzb(zzajiVar.zzcos);
            jSONObjectZzb.remove("impression_urls");
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(AbstractAdViewAdapter.AD_UNIT_ID_PARAMETER, zzajiVar.zzcgs.zzacp);
            return new zzaji(zzajiVar.zzcgs, zzajiVar.zzcos, new zzwy(Arrays.asList(new zzwx(jSONObjectZzb.toString(), null, Arrays.asList("com.google.ads.mediation.admob.AdMobAdapter"), null, null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), jSONObject.toString(), null, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), null, null, null, null, null, Collections.emptyList(), null, -1L)), ((Long) zzkb.zzik().zzd(zznk.zzbao)).longValue(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), false, "", -1L, 0, 1, null, 0, -1, -1L, false), zzajiVar.zzacv, zzajiVar.errorCode, zzajiVar.zzcoh, zzajiVar.zzcoi, zzajiVar.zzcob, zzajiVar.zzcoq, null);
    ...
    public final void zzc(@Nullable zzaig zzaigVar) {
        zzaig zzaigVarZzd = this.zzclg.zzd(zzaigVar);
        if (com.google.android.gms.ads.internal.zzbv.zzfh().zzw(this.zzvw.zzrt) && zzaigVarZzd != null) {
            com.google.android.gms.ads.internal.zzbv.zzfh().zza(this.zzvw.zzrt, com.google.android.gms.ads.internal.zzbv.zzfh().zzab(this.zzvw.zzrt), this.zzvw.zzacp, zzaigVarZzd.type, zzaigVarZzd.zzcmk);
        }
        zza(zzaigVarZzd);
    }
