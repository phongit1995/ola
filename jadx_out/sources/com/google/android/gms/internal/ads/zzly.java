...
public final class zzly {
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                if (viewGroup.isInEditMode()) {
                    zzamu zzamuVarZzif = zzkb.zzif();
                    AdSize adSize = this.zzarh[0];
                    int i2 = this.zzatb;
                    zzjn zzjnVar = new zzjn(context, adSize);
                    zzjnVar.zzarg = zzu(i2);
                    zzamuVarZzif.zza(viewGroup, zzjnVar, "Ads by Google");
                }
    ...
    public final AdSize getAdSize() {
        zzjn zzjnVarZzbk;
        try {
            if (this.zzasy != null && (zzjnVarZzbk = this.zzasy.zzbk()) != null) {
                return zzjnVarZzbk.zzhy();
            }
        } catch (RemoteException e) {
            zzane.zzd("#007 Could not call remote method.", e);
        }
    ...
    public final void zza(zzlw zzlwVar) {
        try {
            if (this.zzasy == null) {
                ...
                zzjn zzjnVarZza = zza(context, this.zzarh, this.zzatb);
                this.zzasy = (zzks) ("search_v2".equals(zzjnVarZza.zzarb) ? zzjr.zza(context, false, (zzjr.zza) new zzjt(zzkb.zzig(), context, zzjnVarZza, this.zzye)) : zzjr.zza(context, false, (zzjr.zza) new zzjs(zzkb.zzig(), context, zzjnVarZza, this.zzye, this.zzast)));
                ...
                this.zzasy.setManualImpressionsEnabled(this.zzvm);
                try {
                    IObjectWrapper iObjectWrapperZzbj = this.zzasy.zzbj();
                    if (iObjectWrapperZzbj != null) {
                        this.zzata.addView((View) ObjectWrapper.unwrap(iObjectWrapperZzbj));
                    }
                } catch (RemoteException e) {
                    zzane.zzd("#007 Could not call remote method.", e);
                }
    ...
    public final boolean zza(zzks zzksVar) {
        ...
        try {
            IObjectWrapper iObjectWrapperZzbj = zzksVar.zzbj();
            if (iObjectWrapperZzbj == null || ((View) ObjectWrapper.unwrap(iObjectWrapperZzbj)).getParent() != null) {
                return false;
            }
            this.zzata.addView((View) ObjectWrapper.unwrap(iObjectWrapperZzbj));
            this.zzasy = zzksVar;
