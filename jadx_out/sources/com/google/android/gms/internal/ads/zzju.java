...
final class zzju extends zzjr.zza<zzks> {
    ...
    zzju(zzjr zzjrVar, Context context, zzjn zzjnVar, String str, zzxn zzxnVar) {
        super();
        this.zzart = zzjrVar;
    ...
    public final /* synthetic */ zzks zza(zzld zzldVar) {
        return zzldVar.createInterstitialAdManager(ObjectWrapper.wrap(this.val$context), this.zzarq, this.zzarr, this.zzars, 12451000);
    }

    @Override // com.google.android.gms.internal.ads.zzjr.zza
    public final /* synthetic */ zzks zzib() {
        zzks zzksVarZza = this.zzart.zzarj.zza(this.val$context, this.zzarq, this.zzarr, this.zzars, 2);
        if (zzksVarZza != null) {
            return zzksVarZza;
        }
