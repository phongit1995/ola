...
public final class zzajm implements zzakh {
    ...
    public final Resources getResources() {
        ...
        try {
            DynamiteModule dynamiteModuleLoad = DynamiteModule.load(this.mContext, DynamiteModule.PREFER_REMOTE, ModuleDescriptor.MODULE_ID);
            if (dynamiteModuleLoad != null) {
                return dynamiteModuleLoad.getModuleContext().getResources();
            }
            return null;
        ...
        if (this.mContext != null && PlatformVersion.isAtLeastJellyBean()) {
            if (!((Boolean) zzkb.zzik().zzd(zznk.zzbau)).booleanValue()) {
                synchronized (this.zzcpt) {
                    ...
                    zzanz<ArrayList<String>> zzanzVarZza = zzaki.zza(new Callable(this) { // from class: com.google.android.gms.internal.ads.zzajn
    ...
    final /* synthetic */ ArrayList zzqj() {
