...
interface zzgj {
    ...
    void zza(int i, zzbu zzbuVar);

    <K, V> void zza(int i, zzea<K, V> zzeaVar, Map<K, V> map);

    void zza(int i, Object obj);

    void zza(int i, Object obj, zzev zzevVar);

    void zza(int i, String str);

    void zza(int i, List<String> list);

    void zza(int i, List<?> list, zzev zzevVar);
    ...
    @Deprecated
    void zzb(int i, Object obj, zzev zzevVar);

    void zzb(int i, List<zzbu> list);

    @Deprecated
    void zzb(int i, List<?> list, zzev zzevVar);
