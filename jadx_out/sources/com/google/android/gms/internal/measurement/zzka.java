...
public final class zzka extends AbstractSafeParcelable {
    ...
    zzka(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) long j, @SafeParcelable.Param(id = 4) Long l, @SafeParcelable.Param(id = 5) Float f, @SafeParcelable.Param(id = 6) String str2, @SafeParcelable.Param(id = 7) String str3, @SafeParcelable.Param(id = 8) Double d) {
        this.versionCode = i;
        this.name = str;
        this.zzast = j;
        this.zzasu = l;
    ...
    zzka(zzkc zzkcVar) {
        this(zzkcVar.name, zzkcVar.zzast, zzkcVar.value, zzkcVar.origin);
    }
