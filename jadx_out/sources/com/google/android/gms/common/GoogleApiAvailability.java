...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    private class zza extends Handler {
        ...
        public final void handleMessage(Message message) {
            if (message.what == 1) {
                int iIsGooglePlayServicesAvailable = GoogleApiAvailability.this.isGooglePlayServicesAvailable(this.zzau);
                if (GoogleApiAvailability.this.isUserResolvableError(iIsGooglePlayServicesAvailable)) {
                    GoogleApiAvailability.this.showErrorNotification(this.zzau, iIsGooglePlayServicesAvailable);
                    return;
                }
                return;
            }
    ...
    private final String zza(Context context, NotificationManager notificationManager) {
        ...
        String strZzb = zzb();
        if (strZzb == null) {
            strZzb = "com.google.android.gms.availability";
    ...
    private final void zza(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (DeviceProperties.isWearable(context)) {
            ...
            notificationBuild = style2.build();
        }
        switch (i) {
            case 1:
            case 2:
    ...
    public Task<Void> makeGooglePlayServicesAvailable(Activity activity) {
        ...
        zzbt zzbtVarZzd = zzbt.zzd(activity);
        zzbtVarZzd.zzb(new ConnectionResult(iIsGooglePlayServicesAvailable, null), 0);
        return zzbtVarZzd.getTask();
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZza = zza(activity, i, DialogRedirect.getInstance(lifecycleFragment, getErrorResolutionIntent(activity, i, "d"), i2), onCancelListener);
        if (dialogZza == null) {
            return false;
        }
