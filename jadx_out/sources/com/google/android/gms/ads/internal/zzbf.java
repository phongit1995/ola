...
final class zzbf implements Runnable {
    ...
    zzbf(zzbc zzbcVar, zzpb zzpbVar, int i, List list) {
        this.zzaaf = zzbcVar;
        this.zzaaj = zzpbVar;
        this.zzaag = i;
        this.zzaak = list;
    ...
    public final void run() {
        try {
            if ((this.zzaaj instanceof zzoq) && this.zzaaf.zzvw.zzadg != null) {
                ...
                zzov zzovVarZza = zzbc.zza(this.zzaaj);
                this.zzaaf.zzvw.zzadg.zza(zzovVarZza);
                this.zzaaf.zzb(zzovVarZza.zzka());
                return;
            }
            ...
            if ((this.zzaaj instanceof zzoo) && this.zzaaf.zzvw.zzadg != null) {
                this.zzaaf.zzvu = this.zzaag != this.zzaak.size() - 1;
                zzov zzovVarZza2 = zzbc.zza(this.zzaaj);
                this.zzaaf.zzvw.zzadg.zza(zzovVarZza2);
                this.zzaaf.zzb(zzovVarZza2.zzka());
                return;
            }
