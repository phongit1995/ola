...
public class AdvertisingIdClient {
    ...
    private static BlockingServiceConnection zza(Context context, boolean z) throws GooglePlayServicesNotAvailableException, IOException {
        try {
    ...
    private final boolean zza(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        map.put("app_context", z ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        if (info != null) {
            map.put("limit_ad_tracking", info.isLimitAdTrackingEnabled() ? "1" : AppEventsConstants.EVENT_PARAM_VALUE_NO);
        }
