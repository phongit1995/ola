...
public class CountryCodeToRegionCodeMap {
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList82.add("RW");
        map.put(Integer.valueOf(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION), arrayList82);
        ...
        arrayList89.add("BI");
        map.put(Integer.valueOf(InputDeviceCompat.SOURCE_KEYBOARD), arrayList89);
