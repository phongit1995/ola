...
class TransitionKitKat extends TransitionImpl {
    ...
    private class CompatListener implements Transition.TransitionListener {
        ...
        public void onTransitionCancel(android.transition.Transition transition) {
            ...
            while (it2.hasNext()) {
                it2.next().onTransitionCancel(TransitionKitKat.this.mExternalTransition);
            }
        }
        ...
        public void onTransitionEnd(android.transition.Transition transition) {
            Iterator<TransitionInterfaceListener> it2 = this.mListeners.iterator();
            while (it2.hasNext()) {
                it2.next().onTransitionEnd(TransitionKitKat.this.mExternalTransition);
            }
        }
        ...
        public void onTransitionPause(android.transition.Transition transition) {
            Iterator<TransitionInterfaceListener> it2 = this.mListeners.iterator();
            while (it2.hasNext()) {
                it2.next().onTransitionPause(TransitionKitKat.this.mExternalTransition);
            }
        }
        ...
        public void onTransitionResume(android.transition.Transition transition) {
            Iterator<TransitionInterfaceListener> it2 = this.mListeners.iterator();
            while (it2.hasNext()) {
                it2.next().onTransitionResume(TransitionKitKat.this.mExternalTransition);
            }
        }
        ...
        public void onTransitionStart(android.transition.Transition transition) {
            Iterator<TransitionInterfaceListener> it2 = this.mListeners.iterator();
            while (it2.hasNext()) {
                it2.next().onTransitionStart(TransitionKitKat.this.mExternalTransition);
            }
        }
    ...
    public void init(TransitionInterface transitionInterface, Object obj) {
        ...
        this.mTransition = obj == null ? new TransitionWrapper(transitionInterface) : (android.transition.Transition) obj;
    }
