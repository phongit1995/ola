...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler {
    ...
    private View findFirstVisibleChildClosestToEnd(boolean z, boolean z2) {
        ...
        return findOneVisibleChild(childCount, childCount2, z, z2);
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (getChildCount() > 0) {
            ...
            accessibilityRecordCompatAsRecord.setFromIndex(findFirstVisibleItemPosition());
            accessibilityRecordCompatAsRecord.setToIndex(findLastVisibleItemPosition());
        }
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                updateLayoutStateToFillStart(i8, i3);
