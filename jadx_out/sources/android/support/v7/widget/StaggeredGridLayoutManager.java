...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        ...
        if (layoutParams.mFullSpan) {
            ...
            if (this.mOrientation != 1) {
                ...
                childMeasureSpec2 = getChildMeasureSpec(this.mSizePerSpan, getHeightMode(), 0, layoutParams.height, false);
                measureChildWithDecorationsAndMargin(view, childMeasureSpec, childMeasureSpec2, z);
            }
            childMeasureSpec = getChildMeasureSpec(this.mSizePerSpan, getWidthMode(), 0, layoutParams.width, false);
        }
    ...
    */
    private void recycle(android.support.v7.widget.RecyclerView.Recycler r3, android.support.v7.widget.LayoutState r4) {
        ...
        L4f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.StaggeredGridLayoutManager.recycle(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.LayoutState):void");
    }
    ...
    */
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (getChildCount() > 0) {
            ...
            if (position < position2) {
                accessibilityRecordCompatAsRecord.setFromIndex(position);
                accessibilityRecordCompatAsRecord.setToIndex(position2);
            } else {
                accessibilityRecordCompatAsRecord.setFromIndex(position2);
                accessibilityRecordCompatAsRecord.setToIndex(position);
            }
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(spanIndex, i, spanIndex2, i2, layoutParams2.mFullSpan, false));
    }
