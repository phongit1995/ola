...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [android.view.Window] */
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            ?? r02 = (ViewGroup) layoutInflaterFrom.inflate(this.mOverlayActionMode ? R.layout.abc_screen_simple_overlay_action_mode : R.layout.abc_screen_simple, (ViewGroup) null);
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(r02, new OnApplyWindowInsetsListener() { // from class: android.support.v7.app.AppCompatDelegateImplV9.2
                ...
                ((FitWindowsViewGroup) r02).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() { // from class: android.support.v7.app.AppCompatDelegateImplV9.3
            ...
            ViewGroup viewGroup = (ViewGroup) layoutInflaterFrom.inflate(R.layout.abc_dialog_title_material, (ViewGroup) null);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) r0.findViewById(R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(r0);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) r0.findViewById(R.id.action_bar_activity_content);
        ViewGroup viewGroup3 = (ViewGroup) this.mWindow.findViewById(android.R.id.content);
        if (viewGroup3 != null) {
        ...
        this.mWindow.setContentView(r0);
