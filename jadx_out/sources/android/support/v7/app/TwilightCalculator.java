...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double dRound = ((double) (Math.round(((double) (r4 - J0)) - r10) + J0)) + ((-d2) / 360.0d) + (Math.sin(d3) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
        ...
        if (dSin2 >= 1.0d) {
            ...
            if (dSin2 > -1.0d) {
                ...
                this.state = (this.sunrise >= j || this.sunset <= j) ? 1 : 0;
                return;
            }
            this.state = 0;
        }
