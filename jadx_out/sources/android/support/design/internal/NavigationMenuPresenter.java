...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final View.OnClickListener mOnClickListener = new View.OnClickListener() { // from class: android.support.design.internal.NavigationMenuPresenter.1
        ...
        public void onClick(View view) {
            ...
            boolean zPerformItemAction = NavigationMenuPresenter.this.mMenu.performItemAction(itemData, NavigationMenuPresenter.this, 0);
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void prepareMenuItems() {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                MenuItemImpl menuItemImpl = NavigationMenuPresenter.this.mMenu.getVisibleItems().get(i2);
                ...
                if (menuItemImpl.hasSubMenu()) {
                    ...
                    if (subMenu.hasVisibleItems()) {
                        ...
                        if (z2) {
                            appendTransparentIconIfMissing(size3, this.mItems.size());
                        }
                    }
                } else {
                    int groupId = menuItemImpl.getGroupId();
                    if (groupId != i) {
                        size2 = this.mItems.size();
    ...
    public View inflateHeaderView(@LayoutRes int i) {
        View viewInflate = this.mLayoutInflater.inflate(i, (ViewGroup) this.mHeaderLayout, false);
