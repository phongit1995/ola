...
public class BaselineLayout extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(iMax4, getSuggestedMinimumWidth()), i, iCombineMeasuredStates), ViewCompat.resolveSizeAndState(Math.max(iMax3, getSuggestedMinimumHeight()), i2, iCombineMeasuredStates << 16));
    }
}
