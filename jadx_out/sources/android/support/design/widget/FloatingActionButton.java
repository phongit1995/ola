...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            this.mAutoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(this.mShadowPadding.left + iMin + this.mShadowPadding.right, iMin + this.mShadowPadding.top + this.mShadowPadding.bottom);
    }
