...
public class LifecycleRegistry extends Lifecycle {
    ...
    private Lifecycle.State calculateTargetState(LifecycleObserver lifecycleObserver) {
        ...
        return min(min(this.mState, entryCeil != null ? entryCeil.getValue().mState : null), this.mParentStates.isEmpty() ? null : this.mParentStates.get(this.mParentStates.size() - 1));
    }
