...
.method public static createFrom(Landroid/view/View;)Landroid/support/transition/ViewOverlay;
    ...
    instance-of v4, v3, Landroid/support/transition/ViewOverlay$OverlayViewGroup;

    if-eqz v4, :cond_0

    check-cast v3, Landroid/support/transition/ViewOverlay$OverlayViewGroup;

    iget-object p0, v3, Landroid/support/transition/ViewOverlay$OverlayViewGroup;->mViewOverlay:Landroid/support/transition/ViewOverlay;
    ...
    :cond_1
    new-instance v1, Landroid/support/transition/ViewGroupOverlay;

    invoke-virtual {v0}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2, v0, p0}, Landroid/support/transition/ViewGroupOverlay;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/View;)V
