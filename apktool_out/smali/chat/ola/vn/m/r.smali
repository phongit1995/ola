...
.field private f:Lchat/ola/vn/m/r$a;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lchat/ola/vn/m/r$1;

    invoke-direct {v0, p0}, Lchat/ola/vn/m/r$1;-><init>(Lchat/ola/vn/m/r;)V

    iput-object v0, p0, Lchat/ola/vn/m/r;->h:Ljava/lang/Runnable;

    return-void
.end method

.method static synthetic a(Lchat/ola/vn/m/r;)Lchat/ola/vn/m/r$a;
    .locals 0

    iget-object p0, p0, Lchat/ola/vn/m/r;->f:Lchat/ola/vn/m/r$a;
...
.method private a(Landroid/widget/ListView;)V
    ...
    :try_start_0
    iget-object v0, p0, Lchat/ola/vn/m/r;->a:Lchat/ola/vn/entity/e;
    ...
    invoke-virtual {p0}, Lchat/ola/vn/m/r;->getActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    iput-object v4, p0, Lchat/ola/vn/m/r;->g:Landroid/widget/LinearLayout;

    iget-object v4, p0, Lchat/ola/vn/m/r;->g:Landroid/widget/LinearLayout;
    ...
    iput-object v4, p0, Lchat/ola/vn/m/r;->d:Lcom/mg/ola/common/widget/OlaViewPager;
    ...
    invoke-virtual {p0}, Lchat/ola/vn/m/r;->getResources()Landroid/content/res/Resources;
    ...
    new-instance v5, Lchat/ola/vn/m/r$a;

    invoke-direct {v5, p0, v3}, Lchat/ola/vn/m/r$a;-><init>(Lchat/ola/vn/m/r;Lchat/ola/vn/m/r$1;)V

    iput-object v5, p0, Lchat/ola/vn/m/r;->f:Lchat/ola/vn/m/r$a;

    iget-object v5, p0, Lchat/ola/vn/m/r;->d:Lcom/mg/ola/common/widget/OlaViewPager;

    iget-object v6, p0, Lchat/ola/vn/m/r;->f:Lchat/ola/vn/m/r$a;

    invoke-virtual {v5, v6}, Lcom/mg/ola/common/widget/OlaViewPager;->setAdapter(Landroid/support/v4/view/PagerAdapter;)V

    iget-object v5, p0, Lchat/ola/vn/m/r;->d:Lcom/mg/ola/common/widget/OlaViewPager;

    iget-object v6, p0, Lchat/ola/vn/m/r;->h:Ljava/lang/Runnable;
    ...
    new-instance v5, Lchat/ola/vn/m/r$4;

    invoke-direct {v5, p0}, Lchat/ola/vn/m/r$4;-><init>(Lchat/ola/vn/m/r;)V
...
.method private a(Lchat/ola/vn/entity/e;Lchat/ola/vn/entity/e;)V
    ...
    iget-object p1, p0, Lchat/ola/vn/m/r;->i:Landroid/view/View;
    ...
    new-instance v1, Lchat/ola/vn/m/r$8;

    invoke-direct {v1, p0, p2}, Lchat/ola/vn/m/r$8;-><init>(Lchat/ola/vn/m/r;Lchat/ola/vn/entity/e;)V
    ...
    :cond_3
    invoke-virtual {p0}, Lchat/ola/vn/m/r;->v()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic b(Lchat/ola/vn/m/r;)Lcom/mg/ola/common/widget/OlaViewPager;
    .locals 0

    iget-object p0, p0, Lchat/ola/vn/m/r;->d:Lcom/mg/ola/common/widget/OlaViewPager;

    return-object p0
.end method

.method static synthetic c(Lchat/ola/vn/m/r;)Ljava/lang/Runnable;
    .locals 0

    iget-object p0, p0, Lchat/ola/vn/m/r;->h:Ljava/lang/Runnable;

    return-object p0
.end method

.method static synthetic d(Lchat/ola/vn/m/r;)Landroid/view/View;
    .locals 0

    iget-object p0, p0, Lchat/ola/vn/m/r;->i:Landroid/view/View;
...
.method public a(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lchat/ola/vn/m/r;->c:Ljava/util/ArrayList;
    ...
    new-instance v0, Lchat/ola/vn/m/r$7;

    invoke-direct {v0, p0}, Lchat/ola/vn/m/r$7;-><init>(Lchat/ola/vn/m/r;)V
    ...
    iget-object v0, p0, Lchat/ola/vn/m/r;->c:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lchat/ola/vn/m/r;->c:Ljava/util/ArrayList;
...
.method protected b(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lchat/ola/vn/m/r;->e:Lchat/ola/vn/b/g;

    iget-object p1, p0, Lchat/ola/vn/m/r;->e:Lchat/ola/vn/b/g;
    ...
    iget-object p1, p0, Lchat/ola/vn/m/r;->b:Landroid/widget/ListView;

    iget-object v0, p0, Lchat/ola/vn/m/r;->e:Lchat/ola/vn/b/g;
...
.method public c()V
    ...
    iget-object v0, p0, Lchat/ola/vn/m/r;->b:Landroid/widget/ListView;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lchat/ola/vn/m/r;->a:Lchat/ola/vn/entity/e;

    iget-object v1, p0, Lchat/ola/vn/m/r;->b:Landroid/widget/ListView;
...
.method public onClick(Landroid/view/View;)V
    ...
    :goto_0
    iget-object p1, p0, Lchat/ola/vn/m/r;->a:Lchat/ola/vn/entity/e;
    ...
    invoke-virtual {p0}, Lchat/ola/vn/m/r;->e()Lchat/ola/vn/m/g;
    ...
    new-instance v2, Lchat/ola/vn/m/r$6;

    invoke-direct {v2, p0}, Lchat/ola/vn/m/r$6;-><init>(Lchat/ola/vn/m/r;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lchat/ola/vn/m/r;->c()V
    ...
    new-instance v2, Lchat/ola/vn/m/r$5;

    invoke-direct {v2, p0}, Lchat/ola/vn/m/r$5;-><init>(Lchat/ola/vn/m/r;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object p2, p0, Lchat/ola/vn/m/r;->i:Landroid/view/View;
    ...
    iput-object p2, p0, Lchat/ola/vn/m/r;->b:Landroid/widget/ListView;

    iget-object p2, p0, Lchat/ola/vn/m/r;->b:Landroid/widget/ListView;

    new-instance p3, Lchat/ola/vn/m/r$2;

    invoke-direct {p3, p0}, Lchat/ola/vn/m/r$2;-><init>(Lchat/ola/vn/m/r;)V

    invoke-virtual {p2, p3}, Landroid/widget/ListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object p2, p0, Lchat/ola/vn/m/r;->b:Landroid/widget/ListView;

    new-instance p3, Lchat/ola/vn/m/r$3;

    invoke-direct {p3, p0}, Lchat/ola/vn/m/r$3;-><init>(Lchat/ola/vn/m/r;)V
    ...
    invoke-direct {p0, p2}, Lchat/ola/vn/m/r;->a(Landroid/widget/ListView;)V
...
.method protected v()V
    ...
    iget-object v1, p0, Lchat/ola/vn/m/r;->a:Lchat/ola/vn/entity/e;
    ...
    iget-object v2, p0, Lchat/ola/vn/m/r;->a:Lchat/ola/vn/entity/e;

    invoke-direct {p0, v2, v1}, Lchat/ola/vn/m/r;->a(Lchat/ola/vn/entity/e;Lchat/ola/vn/entity/e;)V

    :cond_1
    :goto_0
    iget-object v1, p0, Lchat/ola/vn/m/r;->e:Lchat/ola/vn/b/g;
    ...
    iget-object v0, p0, Lchat/ola/vn/m/r;->i:Landroid/view/View;
    ...
    :cond_6
    iget-object v0, p0, Lchat/ola/vn/m/r;->f:Lchat/ola/vn/m/r$a;

    if-eqz v0, :cond_7

    iget-object v0, p0, Lchat/ola/vn/m/r;->f:Lchat/ola/vn/m/r$a;

    invoke-virtual {v0}, Lchat/ola/vn/m/r$a;->notifyDataSetChanged()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
