...
public class s extends q implements View.OnClickListener, View.OnLongClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, j.a {
    private ListView b;
    private OlaViewPager d;
    private chat.ola.vn.b.g e;
    private a f;
    private Runnable g = new Runnable() { // from class: chat.ola.vn.m.s.1
        @Override // java.lang.Runnable
        public void run() {
            OlaViewPager olaViewPager;
            int childCount = s.this.d.getChildCount();
            int currentItem = s.this.d.getCurrentItem();
            if (currentItem >= childCount - 1) {
                olaViewPager = s.this.d;
                currentItem = 0;
            } else {
                olaViewPager = s.this.d;
            }
            olaViewPager.setCurrentItem(currentItem, true);
            s.this.d.postDelayed(this, 5000L);
        }
    };
    private View h;
    private View i;
    ...
    private class a extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            chat.ola.vn.entity.e eVarG = s.this.a.g(i);
            ...
            hVar.a((View.OnClickListener) s.this);
            hVar.a(eVarG);
            if (hVar.a != null) {
    ...
    private void a(ListView listView) {
        try {
            if (this.a.u() != 0) {
                ...
                this.j = (LinearLayout) viewInflate.findViewById(R.id.linearPageTabSpan);
                ...
                circlePageIndicator.setOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: chat.ola.vn.m.s.2
                    @Override // android.support.v4.view.ViewPager.OnPageChangeListener
                    public void onPageScrollStateChanged(int i) {
                        s.this.d.removeCallbacks(s.this.g);
                        if (i != 0) {
                            return;
                        }
                        s.this.d.postDelayed(s.this.g, 5000L);
                    }
    ...
    private void a(chat.ola.vn.entity.e eVar, final chat.ola.vn.entity.e eVar2) {
        ...
        try {
            if (eVar2.p()) {
                ...
                eVar2.b(true);
                OlaApplication.b.b(eVar2.t(), new chat.ola.vn.p.b() { // from class: chat.ola.vn.m.s.9
                    @Override // chat.ola.vn.p.b
                    public void a(String str, String str2) {
                        OlaApplication.a(new Runnable() { // from class: chat.ola.vn.m.s.9.2
                            @Override // java.lang.Runnable
                            public void run() {
                                try {
                                    eVar2.e(true);
                    ...
                    public void a(String str, String str2, final chat.ola.vn.entity.e eVar3) {
                        OlaApplication.a(new Runnable() { // from class: chat.ola.vn.m.s.9.1
                            @Override // java.lang.Runnable
                            public void run() {
                                try {
                                    eVar2.g(eVar3.w());
    ...
    private void b(final chat.ola.vn.entity.e eVar) {
        ...
        eVar.b(true);
        OlaApplication.b.b(strH, new chat.ola.vn.p.b() { // from class: chat.ola.vn.m.s.5
            @Override // chat.ola.vn.p.b
            public void a(String str, String str2) {
                OlaApplication.a(new Runnable() { // from class: chat.ola.vn.m.s.5.2
                    @Override // java.lang.Runnable
                    public void run() {
                        try {
                            eVar.b(false);
            ...
            public void a(String str, String str2, final chat.ola.vn.entity.e eVar2) {
                OlaApplication.a(new Runnable() { // from class: chat.ola.vn.m.s.5.1
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public boolean B() {
        try {
            ...
            return eVarL != null ? (eVarL.k() || eVarL.h() == null) ? false : true : (this.a.k() || this.a.h() == null) ? false : true;
        } catch (Throwable unused) {
            return false;
        }
    }
    ...
    public ArrayList<chat.ola.vn.mediastore.a> a(Context context) {
        ...
        aVar.f = new View.OnClickListener() { // from class: chat.ola.vn.m.s.6
    ...
    public void onClick(View view) {
        ...
        try {
            ...
            if (id == R.id.imgVideoThumbnail) {
                ...
                if (eVar.E() == 101) {
                    g().a(eVar.t(), eVar.J(), new chat.ola.vn.p.b() { // from class: chat.ola.vn.m.s.3
                        @Override // chat.ola.vn.p.b
                        public void a(String str2, String str3) {
                        }

                        @Override // chat.ola.vn.p.b
                        public void a(String str2, String str3, chat.ola.vn.entity.e eVar2) {
                            eVar2.j(1);
                        }
                    });
                    return;
            ...
            if (id != R.id.linearMallItemTabSpan) {
                switch (id) {
                    ...
                    case R.id.btnMallItemDetailComment /* 2131296486 */:
                        ...
                        g().a(eVar2.t(), eVar2.J(), new chat.ola.vn.p.b() { // from class: chat.ola.vn.m.s.4
                            @Override // chat.ola.vn.p.b
                            public void a(String str2, String str3) {
                            }
                    ...
                    case R.id.btnMallItemDetailShare /* 2131296488 */:
                        ...
                        OlaMeComposerActivity.a(getActivity(), str, (String) null);
                        break;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.i = layoutInflater.inflate(R.layout.load_more_watting_span_view, (ViewGroup) null);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        try {
            ...
            g().a(eVar.t(), eVar.J(), new chat.ola.vn.p.b() { // from class: chat.ola.vn.m.s.7
                @Override // chat.ola.vn.p.b
                public void a(String str, String str2) {
                }
    ...
    public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long j) {
        try {
            chat.ola.vn.entity.e eVar = (chat.ola.vn.entity.e) adapterView.getAdapter().getItem(i);
            g().a(eVar.t(), eVar.J(), new chat.ola.vn.p.b() { // from class: chat.ola.vn.m.s.8
                @Override // chat.ola.vn.p.b
                public void a(String str, String str2) {
                }
