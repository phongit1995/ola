...
public class s implements w {
    ...
    public s(String str, PhotoView photoView, ImageView.ScaleType scaleType, View view, int i, boolean z) {
        this.d = 480;
        this.e = false;
    ...
    public void c(String str) {
        ...
        try {
            if (chat.ola.vn.util.m.a(str, this.a.get().getLoadingUrl())) {
                ...
                fVarG.a(new g() { // from class: chat.ola.vn.c.s.1
                    ...
                    public void a(f fVar) {
                        try {
                            ...
                            PhotoView photoView = s.this.a.get();
                            if (chat.ola.vn.util.m.a(photoView.getLoadingUrl(), fVar.e())) {
                                ...
                                photoView.setScaleType(s.this.f);
                                photoView.a(bitmapC, fVar.e());
