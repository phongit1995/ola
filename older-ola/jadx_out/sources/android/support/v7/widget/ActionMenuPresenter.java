...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z2 || i8 + i7 > i6)) {
            i6--;
        }
        int i10 = i6 - i7;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            iMeasureChildForCells = i5 / actionMenuPresenter.mMinCellSize;
            i = ((i5 % actionMenuPresenter.mMinCellSize) / iMeasureChildForCells) + actionMenuPresenter.mMinCellSize;
        } else {
        ...
        while (i12 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z4 = (i10 > 0 || z3) && i11 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                if (z4) {
                    boolean z5 = z4;
                    ...
                    z4 = z5 & (!actionMenuPresenter.mStrictWidthLimit ? i11 + i13 <= 0 : i11 < 0);
                } else {
                    i2 = size;
                }
                if (z4 && groupId2 != 0) {
