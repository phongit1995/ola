...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        this.mTmpAddedFragments.clear();
        if (!z) {
            FragmentTransition.startTransitions(this, arrayList, arrayList2, i4, i2, false);
        }
        ...
        if (i3 != i4 && z) {
            FragmentTransition.startTransitions(this, arrayList, arrayList2, i4, i3, true);
            moveToState(this.mCurState, true);
        }
        while (i4 < i2) {
    ...
    */
    private void executePostponedTransaction(java.util.ArrayList<android.support.v4.app.BackStackRecord> r8, java.util.ArrayList<java.lang.Boolean> r9) {
        ...
        Lf:
            ...
            r4 = -1
            if (r8 == 0) goto L3c
            boolean r5 = android.support.v4.app.FragmentManagerImpl.StartEnterTransitionListener.access$300(r3)
            if (r5 != 0) goto L3c
            android.support.v4.app.BackStackRecord r5 = android.support.v4.app.FragmentManagerImpl.StartEnterTransitionListener.access$400(r3)
    ...
    private static void setRetaining(FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        if (childNonConfigs != null) {
            Iterator<FragmentManagerNonConfig> it3 = childNonConfigs.iterator();
            while (it3.hasNext()) {
                setRetaining(it3.next());
            }
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:215:0x044d A[FALL_THROUGH, PHI: r11
      0x044d: PHI (r11v2 int) = (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v3 int), (r11v3 int) binds: [B:137:0x02ea, B:139:0x02ee, B:187:0x03d7, B:209:0x0438, B:213:0x0442, B:212:0x043e, B:41:0x006a, B:131:0x02c0, B:135:0x02dc] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (fragmentFindFragmentById == null) {
            Fragment fragmentInstantiate = this.mContainer.instantiate(context, str2, null);
