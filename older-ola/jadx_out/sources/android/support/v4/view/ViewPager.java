...
public class ViewPager extends ViewGroup {
    ...
    private boolean pageScrolled(int i) {
        ...
        float f2 = ((i / f) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + (this.mPageMargin / f));
        this.mCalledSuper = false;
    ...
    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        ...
        if (i2 <= 0 || this.mItems.isEmpty()) {
            ...
            iMin = (int) ((itemInfoInfoForPosition != null ? Math.min(itemInfoInfoForPosition.offset, this.mLastOffset) : 0.0f) * ((i - getPaddingLeft()) - getPaddingRight()));
            if (iMin == getScrollX()) {
                return;
            } else {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (itemInfoInfoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), CrashUtils.ErrorDialogData.SUPPRESSED), View.MeasureSpec.makeMeasureSpec((i6 - measuredHeight2) - measuredHeight, CrashUtils.ErrorDialogData.SUPPRESSED));
                    }
    ...
    */
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    ItemInfo itemInfoInfoForCurrentScrollPosition = infoForCurrentScrollPosition();
                    float f = clientWidth;
                    setCurrentItemInternal(determineTargetPage(itemInfoInfoForCurrentScrollPosition.position, ((scrollX / f) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + (this.mPageMargin / f)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x00c4, code lost:
        ...
        r8 = null;
     */
    /* JADX WARN: Removed duplicated region for block: B:69:0x013e A[PHI: r7 r10 r15
      0x013e: PHI (r7v14 float) = (r7v12 float), (r7v13 float), (r7v5 float) binds: [B:68:0x013c, B:65:0x012e, B:59:0x0120] A[DONT_GENERATE, DONT_INLINE]
      0x013e: PHI (r10v7 int) = (r10v1 int), (r10v6 int), (r10v11 int) binds: [B:68:0x013c, B:65:0x012e, B:59:0x0120] A[DONT_GENERATE, DONT_INLINE]
      0x013e: PHI (r15v6 int) = (r15v5 int), (r15v4 int), (r15v10 int) binds: [B:68:0x013c, B:65:0x012e, B:59:0x0120] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:70:0x0147 A[PHI: r7 r10 r15
      0x0147: PHI (r7v17 float) = (r7v12 float), (r7v13 float), (r7v5 float) binds: [B:68:0x013c, B:65:0x012e, B:59:0x0120] A[DONT_GENERATE, DONT_INLINE]
      0x0147: PHI (r10v10 int) = (r10v1 int), (r10v6 int), (r10v11 int) binds: [B:68:0x013c, B:65:0x012e, B:59:0x0120] A[DONT_GENERATE, DONT_INLINE]
      0x0147: PHI (r15v9 int) = (r15v5 int), (r15v4 int), (r15v10 int) binds: [B:68:0x013c, B:65:0x012e, B:59:0x0120] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i5) / ((f * this.mAdapter.getPageWidth(this.mCurItem)) + this.mPageMargin)) + 1.0f) * 100.0f), MAX_SETTLE_DURATION);
