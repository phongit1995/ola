...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        /* JADX WARN: Removed duplicated region for block: B:9:0x001f A[PHI: r2
          0x001f: PHI (r2v33 android.graphics.Bitmap) = (r2v6 android.graphics.Bitmap), (r2v37 android.graphics.Bitmap) binds: [B:14:0x003b, B:8:0x001d] A[DONT_GENERATE, DONT_INLINE]] */
        /*
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            this.mImpl = Build.VERSION.SDK_INT >= 19 ? new MediaSessionImplApi19(context, str, componentName, pendingIntent) : Build.VERSION.SDK_INT >= 18 ? new MediaSessionImplApi18(context, str, componentName, pendingIntent) : new MediaSessionImplBase(context, str, componentName, pendingIntent);
        }
        this.mController = new MediaControllerCompat(context, this);
        if (sMaxBitmapSize == 0) {
