...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 1) {
            ...
            setResult(i2, intent);
            if (booleanExtra) {
                GoogleApiManager googleApiManagerZzb = GoogleApiManager.zzb(this);
                switch (i2) {
                    case -1:
                        googleApiManagerZzb.zzr();
                        break;
                    case 0:
                        googleApiManagerZzb.zza(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1));
                        break;
                }
            }
        } else if (i == 2) {
