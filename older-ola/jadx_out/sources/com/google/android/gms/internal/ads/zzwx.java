...
public final class zzwx {
    ...
    public zzwx(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObjectOptJSONObject != null) {
            com.google.android.gms.ads.internal.zzbv.zzfd();
            listZza = zzxg.zza(jSONObjectOptJSONObject, "manual_impression_urls");
        } else {
            listZza = null;
        }
        this.zzbrz = listZza;
        this.zzbrr = jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.toString() : null;
        JSONObject jSONObjectOptJSONObject2 = jSONObject.optJSONObject("data");
        this.zzbsb = jSONObjectOptJSONObject2 != null ? jSONObjectOptJSONObject2.toString() : null;
        this.zzbrv = jSONObjectOptJSONObject2 != null ? jSONObjectOptJSONObject2.optString("class_name") : null;
        ...
        this.zzbsh = jSONObjectOptJSONObject3 != null ? jSONObjectOptJSONObject3.toString() : null;
        com.google.android.gms.ads.internal.zzbv.zzfd();
        ...
        this.zzbsj = jSONObjectOptJSONObject4 != null ? jSONObjectOptJSONObject4.toString() : null;
        this.zzbsk = jSONObject.optString(ServerProtocol.DIALOG_PARAM_RESPONSE_TYPE, null);
    ...
    public final boolean zzmg() {
        return AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_NATIVE.equalsIgnoreCase(this.zzbsk);
    }
}
