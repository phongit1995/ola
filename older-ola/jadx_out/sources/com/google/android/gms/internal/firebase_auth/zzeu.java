...
interface zzeu {
    ...
    <T> T zza(zzev<T> zzevVar, zzco zzcoVar);

    <T> void zza(List<T> list, zzev<T> zzevVar, zzco zzcoVar);

    <K, V> void zza(Map<K, V> map, zzea<K, V> zzeaVar, zzco zzcoVar);

    @Deprecated
    <T> T zzb(zzev<T> zzevVar, zzco zzcoVar);

    @Deprecated
    <T> void zzb(List<T> list, zzev<T> zzevVar, zzco zzcoVar);
