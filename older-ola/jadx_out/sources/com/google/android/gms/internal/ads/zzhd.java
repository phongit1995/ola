...
public final class zzhd {
    ...
    public final void connect() {
        synchronized (this.mLock) {
            if (this.mContext != null && this.zzajr == null) {
                this.zzajr = new zzhk(this.mContext, com.google.android.gms.ads.internal.zzbv.zzez().zzsa(), new zzhg(this), new zzhh(this));
    ...
    static /* synthetic */ zzhk zza(zzhd zzhdVar, zzhk zzhkVar) {
        zzhdVar.zzajr = null;
        return null;
    }
