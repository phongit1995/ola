...
public final class zzwy {
    ...
    public zzwy(JSONObject jSONObject) throws JSONException {
        if (zzakb.isLoggable(2)) {
            ...
            zzakb.v(strValueOf.length() != 0 ? "Mediation Response JSON: ".concat(strValueOf) : new String("Mediation Response JSON: "));
        }
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            ...
            if (i < 0) {
                Iterator<String> it2 = zzwxVar.zzbrt.iterator();
                while (true) {
                    if (it2.hasNext()) {
        ...
        this.zzbsl = jSONObjectOptJSONObject.optLong("ad_network_timeout_millis", -1L);
        com.google.android.gms.ads.internal.zzbv.zzfd();
        this.zzbsn = zzxg.zza(jSONObjectOptJSONObject, "click_urls");
        com.google.android.gms.ads.internal.zzbv.zzfd();
        this.zzbso = zzxg.zza(jSONObjectOptJSONObject, "imp_urls");
        com.google.android.gms.ads.internal.zzbv.zzfd();
        this.zzbsp = zzxg.zza(jSONObjectOptJSONObject, "downloaded_imp_urls");
        com.google.android.gms.ads.internal.zzbv.zzfd();
        this.zzbsq = zzxg.zza(jSONObjectOptJSONObject, "nofill_urls");
        com.google.android.gms.ads.internal.zzbv.zzfd();
        this.zzbsr = zzxg.zza(jSONObjectOptJSONObject, "remote_ping_urls");
        this.zzbss = jSONObjectOptJSONObject.optBoolean("render_in_browser", false);
        long jOptLong = jSONObjectOptJSONObject.optLong("refresh", -1L);
        this.zzbsu = jOptLong > 0 ? 1000 * jOptLong : -1L;
        zzaig zzaigVarZza = zzaig.zza(jSONObjectOptJSONObject.optJSONArray("rewards"));
        if (zzaigVarZza == null) {
            this.zzbsv = null;
            this.zzbsw = 0;
        } else {
            this.zzbsv = zzaigVarZza.type;
            this.zzbsw = zzaigVarZza.zzcmk;
        }
        this.zzbsz = jSONObjectOptJSONObject.optBoolean("use_displayed_impression", false);
        this.zzbta = jSONObjectOptJSONObject.optBoolean("allow_pub_rendered_attribution", false);
        this.zzbtb = jSONObjectOptJSONObject.optBoolean("allow_pub_owned_ad_view", false);
    }
}
