...
public final class s implements YouTubePlayer {
    ...
    public s(b bVar, d dVar) {
        this.a = (b) ac.a(bVar, "connectionClient cannot be null");
        this.b = (d) ac.a(dVar, "embeddedPlayer cannot be null");
    }
        ...
        try {
            this.b.a(new g.a() { // from class: com.google.android.youtube.player.internal.s.3
                ...
                public final void b(String str) {
                    YouTubePlayer.ErrorReason errorReasonValueOf;
                    try {
                        errorReasonValueOf = YouTubePlayer.ErrorReason.valueOf(str);
                    } catch (IllegalArgumentException | NullPointerException unused) {
                        errorReasonValueOf = YouTubePlayer.ErrorReason.UNKNOWN;
                    }
                    playerStateChangeListener.onError(errorReasonValueOf);
                }
