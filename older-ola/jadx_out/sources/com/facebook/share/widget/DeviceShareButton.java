...
public final class DeviceShareButton extends FacebookButtonBase {
    ...
    public DeviceShareDialog getDialog() {
        ...
        this.dialog = getFragment() != null ? new DeviceShareDialog(getFragment()) : getNativeFragment() != null ? new DeviceShareDialog(getNativeFragment()) : new DeviceShareDialog(getActivity());
        return this.dialog;
    }
