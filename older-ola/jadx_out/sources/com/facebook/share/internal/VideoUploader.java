...
public class VideoUploader {
        ...
        public void initialize() throws FileNotFoundException {
            try {
                if (Utility.isFileUri(this.videoUri)) {
                    ParcelFileDescriptor parcelFileDescriptorOpen = ParcelFileDescriptor.open(new File(this.videoUri.getPath()), CrashUtils.ErrorDialogData.BINDER_CRASH);
        ...
        protected void executeGraphRequestSynchronously(Bundle bundle) {
            ...
            if (graphResponseExecuteAndWait != null) {
                ...
                if (error != null) {
                    ...
                    facebookException = new FacebookException(VideoUploader.ERROR_BAD_SERVER_RESPONSE);
                }
            } else {
                facebookException = new FacebookException(VideoUploader.ERROR_BAD_SERVER_RESPONSE);
            }
    ...
    public static synchronized void cancelAllRequests() {
        Iterator<UploadContext> it2 = pendingUploads.iterator();
        while (it2.hasNext()) {
