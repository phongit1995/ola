...
public class AccountVerifiedContentController extends ContentControllerBase {
    ...
    public void onResume(final Activity activity) {
        ...
        this.delayedTransitionRunnable = new Runnable() { // from class: com.facebook.accountkit.ui.AccountVerifiedContentController.1
            @Override // java.lang.Runnable
            public void run() {
                LocalBroadcastManager.getInstance(activity).sendBroadcast(new Intent(LoginFlowBroadcastReceiver.ACTION_UPDATE).putExtra(LoginFlowBroadcastReceiver.EXTRA_EVENT, LoginFlowBroadcastReceiver.Event.ACCOUNT_VERIFIED_COMPLETE));
