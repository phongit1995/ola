...
public class PlaceManager {
    ...
    public static Bundle getCurrentPlaceParameters(CurrentPlaceRequestParams currentPlaceRequestParams, LocationPackage locationPackage) {
        ...
        try {
            ...
            if (locationPackage != null) {
                ...
                if (list != null) {
                    ...
                    while (it2.hasNext()) {
                        jSONArray.put(getWifiScanJson(it2.next()));
                    }
    ...
    public static GraphRequest newCurrentPlaceFeedbackRequest(CurrentPlaceFeedbackRequestParams currentPlaceFeedbackRequestParams) {
        ...
        Boolean boolWasHere = currentPlaceFeedbackRequestParams.wasHere();
        if (tracking == null || placeId == null || boolWasHere == null) {
        ...
        bundle.putBoolean(PARAM_WAS_HERE, boolWasHere.booleanValue());
