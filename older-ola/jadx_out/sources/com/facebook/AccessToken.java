...
public final class AccessToken implements Parcelable {
            ...
            if (string != null && !string.isEmpty()) {
                ...
                if (string2 == null || string2.isEmpty()) {
                    Utility.getGraphMeRequestWithCacheAsync(string, new Utility.GraphMeRequestWithCacheCallback() { // from class: com.facebook.AccessToken.1
                        ...
                        public void onFailure(FacebookException facebookException2) {
                            accessTokenCreationCallback.onError(facebookException2);
                        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.userId.equals(accessToken.userId);
    }
